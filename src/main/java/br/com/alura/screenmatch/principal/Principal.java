...
public class Principal {
    ...
    public void exibeMenu() {
        ...
        Optional<Episodio> piorEpisodio = episodios.stream()
                ...
                .limit(1)
                .findFirst();
        System.out.println("Titulo: " + piorEpisodio.get().getTitulo().toUpperCase() +
                ", Temporada: " + piorEpisodio.get().getTemporada() +
                ", nota: " + piorEpisodio.get().getAvaliacao());
        ...
        Optional<Episodio> melhorEpisodio = episodios.stream()
                ...
                .limit(1)
                .findFirst();
        System.out.println("Titulo: " + melhorEpisodio.get().getTitulo().toUpperCase() +
                ", Temporada: " + melhorEpisodio.get().getTemporada() +
                ", nota: " + melhorEpisodio.get().getAvaliacao());
